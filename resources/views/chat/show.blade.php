        ...
        <header class="border-2 border-zinc-950 bg-zinc-50 dark:border-zinc-100 dark:bg-zinc-950">
            ...
            <div class="flex flex-col gap-4 p-6">
                ...
                <div class="flex flex-row items-center gap-3">
                    <flux:tooltip :content="__('Chat settings')" position="bottom">
                        <flux:button
                            :href="route('chat.settings', $recipient)"
                            icon="cog-6-tooth"
                            :aria-label="__('Chat settings')"
                            wire:navigate
                            class="!rounded-none !border-2 !border-zinc-950 !bg-zinc-50 !text-zinc-950 hover:!bg-zinc-200 dark:!border-zinc-100 dark:!bg-zinc-950 dark:!text-zinc-50 dark:hover:!bg-zinc-800"
                        />
                    </flux:tooltip>

                    <flux:tooltip :content="__('Inbox')" position="bottom">
                        <flux:button
